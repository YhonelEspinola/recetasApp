...
class ListaRecetasAdapter : RecyclerView.Adapter<ListaRecetaViewHolder>() {
   private var list = emptyList<Receta>()
    private var listFilter : List<Receta> = list
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListaRecetaViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return ListaRecetaViewHolder(inflater, parent)
    }
    ...
    override fun onBindViewHolder(holder: ListaRecetaViewHolder, position: Int) {
